...
import { MousePointer, Code, X } from "lucide-react"
import IconButton from "../ui/IconButton"
import Button from "../ui/Button"
import CssIcon from "../ui/CssIcon"

export type CssToolbarMode = "inspect-element"

interface CssIslandToolbarProps {
  currentMode: CssToolbarMode
  onModeChange: (mode: CssToolbarMode) => void
  onClose: () => void
  isDarkMode: boolean
}

export const CssIslandToolbar: React.FC<CssIslandToolbarProps> = ({
  currentMode,
  onModeChange,
  onClose,
  isDarkMode
...
export default CssIslandToolbar
